...
<html lang="pt-BR">
 ...
 <section>
   <div class="container">
	<br><br><br>
   <!------------------------------ Form Contato  ---------------------------->
    <form action="core/inserir-obras.php" method="post">
      <div class="card" style="padding:10px">
          <h4 class="card-header">Nova Obra</h4>
          <br>
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
				...
				name="obra" placeholder="Obra Itamarati Siqueira">
            </div>
			<div class="form-group col-md-3">
				<input type="text" class="form-control" 
            ...
            <div class="form-group col-md-12">
				<input type="text" class="form-control" 
				name="resp" placeholder="Responsável pela obra">
            </div>
          </div>
        </div>
        <br>
    ...
    <div class="card" style="padding:10px">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
                ...
                name="telefone" placeholder="(62) 98592-1140" >
              </div>
            <div class="form-group col-md-8">
              ...
              <div class="form-group col-md-8">
				<input type="text" class="form-control" 
				name="complemento" placeholder="Quadra 18A, Lote 27, N. 500" />
            </div>
            <div class="form-group col-md-4">
				<input type="text" class="form-control" 
            ...
            <div class="form-group col-md-8">
				<input type="text" class="form-control" 
				name="estado" placeholder="UF" readonly id="uf" />
            </div>
          </div>
        </div>
        <br>
